...
#define     _CSI_(code)           "\033["#code"m" /**< ANSI CSI指令 */

/**
 * log级别字符(包含颜色)
 */
#if LOG_USING_COLOR == 1
#define     ERROR_TEXT          _CSI_(31)"E(%d) %s:"_CSI_(39)       /**< 错误标签 */
#define     WARNING_TEXT        _CSI_(33)"W(%d) %s:"_CSI_(39)       /**< 警告标签 */
#define     INFO_TEXT           _CSI_(32)"I(%d) %s:"_CSI_(39)       /**< 信息标签 */
#define     DEBUG_TEXT          _CSI_(34)"D(%d) %s:"_CSI_(39)       /**< 调试标签 */
#define     VERBOSE_TEXT        _CSI_(36)"V(%d) %s:"_CSI_(39)       /**< 冗余信息标签 */
#else
